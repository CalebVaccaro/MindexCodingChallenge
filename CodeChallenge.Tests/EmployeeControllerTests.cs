...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        // Non-existent employee, Not found, and returns 0 reports
        [TestMethod]
        public void GetReportingStructure_Returns_NotFound()
        {
            // Arrange
            var nonExistentEmployeeId = "00000000-0000-0000-0000-000000000000";
            var expectedNumberOfReports = 0;

            // Act
            var getRequestTask = _httpClient.GetAsync($"api/employee/{nonExistentEmployeeId}/reportingStructure");
            var response = getRequestTask.Result;
            var reportingStructure = response.DeserializeContent<ReportingStructure>();
